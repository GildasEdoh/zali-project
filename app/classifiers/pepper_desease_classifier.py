"""
Plant Type Classification Inference
Load trained model and predict on single images
"""
...
class Config:
    ...
    MODEL_SAVE_PATH = '/kaggle/working/best_pepper_desease_classifier.pth'
...
_pepper_desease_classifier : Optional[PepperDeseaseClassifier] = None

def get_pepper_classifier(model_path) -> PepperDeseaseClassifier:
    global _pepper_desease_classifier
    if _pepper_desease_classifier is None:
        _pepper_desease_classifier = PepperDeseaseClassifier(model_path)
    return _pepper_desease_classifier
...
if __name__ == '__main__':
    ...
    model_path = '/Users/v9/Documents/Documents personnels EDOH Yao Gildas/agriVision/app/models/pepper_best_plant_classifier.pth'
    
    # Create classifier
    classifier = PepperDeseaseClassifier(model_path)
