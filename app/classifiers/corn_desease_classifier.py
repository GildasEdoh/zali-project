...
class Config:
    ...
    MODEL_SAVE_PATH = '/kaggle/working/best_corn_desease_classifier.pth'
...
def get_corn_classifier(model_path) -> CornDeseaseClassifier:
    ...
    return _corn_desease_classifier
...
if __name__ == '__main__':
    ...
    # Create classifier
    classifier = CornDeseaseClassifier(model_path)
