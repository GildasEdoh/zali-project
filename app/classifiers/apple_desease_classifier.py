...
class Config:
    ...
    MODEL_SAVE_PATH = '/kaggle/working/best_apple_desease_classifier.pth'
...
def get_apple_classifier(model_path) -> AppleDeseaseClassifier:
    ...
    return _apple_desease_classifier
...
if __name__ == '__main__':
    ...
    model_path = '/Users/v9/Documents/Documents personnels EDOH Yao Gildas/agriVision/app/models/best_apple_desease_classifier.pth'
    
    # Create classifier
    classifier = AppleDeseaseClassifier(model_path)
