...
class Config:
    ...
    CLASSES = ['Corn_(maize)', 'Pepper__bell', 'Potato', 'Tomato', 'Apple']
...
def get_classifier(model_path) -> PlantClassifier:
    global _plant_classifier
    if _plant_classifier is None:
        _plant_classifier = PlantClassifier(model_path)
...
if __name__ == '__main__':
    ...
    model_path = '/Users/v9/Documents/Documents personnels EDOH Yao Gildas/agriVision/app/models/best_plant_classifier.pth'
    
    # Create classifier
    classifier = PlantClassifier(model_path)
