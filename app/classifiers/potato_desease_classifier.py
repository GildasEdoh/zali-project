...
class Config:
    ...
    MODEL_SAVE_PATH = '/kaggle/working/best_potato_desease_classifier.pth'
...
def get_potato_classifier(model_path) -> PotatoDeseaseClassifier:
    ...
    return _potato_desease_classifier
...
if __name__ == '__main__':
    ...
    model_path = '/Users/v9/Documents/Documents personnels EDOH Yao Gildas/agriVision/app/models/best_potato_desease_classifier.pth'
    
    # Create classifier
    classifier = PotatoDeseaseClassifier(model_path)
